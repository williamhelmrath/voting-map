      ...
      <div>
        <Container maxWidth="lg" component="main" style={{ padding: "65px" }}>
          ...
          <Typography
            ...
            component="p"
          >
            Drag the marker on the map to any location OR type your address in
            the search bar and click the icon
          </Typography>
        </Container>
        <SearchBar parentCallback={this.callbackFunction} /> <br></br>
        <br></br>
        <div
          style={{
            alignItems: "stretch",
